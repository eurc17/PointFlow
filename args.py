...
def add_args(parser):
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Path to the directory storing object bounding box labels",
    )
    parser.add_argument(
        "--pcd_dir",
        required=True,
        type=str,
        help="Path to the directory storing point clouds",
    )
    parser.add_argument(
        "--gen_point_num",
        default=2048,
        type=int,
        help="Number of points to generate during inference",
    )
    parser.add_argument(
        "--resize_flag",
        default=False,
        action="store_true",
        help="To resize the car to 1/10 size or not",
    )
    parser.add_argument(
        "--rotate_flag",
        default=False,
